...
@client.event
async def on_ready():
  await client.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name="/information"))
  await tree.sync()
...
@tree.command(name="info", description="Information about AndrewBot")
...
#keep_alive()
client.run("MTIxMDU5OTA3NzQwNzEwMDk4OQ.Gd-H7w.uNAYGU9PE0dw0emLNgj00MqqcpEMa7FUTaClzw")
